...
async function handleCreateRace() {
	...
	try {
		...
		// alert user if player or track is not selected
		if (!player_id) {
			alert('You have to select a player!');
		} else if (!track_id) {
			alert('You have to select a track!')
		} else {
		...
		console.log(`- handleCreateRace() - function caused the error: `, err.message);
		console.log(err);
	}
	...
	return new Promise(resolve => {
		...
		const raceInterval = setInterval(async () => {
			...
			try {
				...
				// update leaderboard when "in progress":
				...
				console.log(`- getRace() - function caused the error:  `, err.message);
				console.log(err);
...
async function runCountdown() {
	try {
		...
		console.log(`- runCountdown() - function caused the error: `, err.message);
		console.log(err);
	}
}
...
// Fetch call with error handling for each of the following API endpoints 
